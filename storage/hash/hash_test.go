...
const (
	...
	jpegHash = "709e291268aea5f67a3397679b6fd9cd160a"
)
...
func TestHash(t *testing.T) {
	...
	assert.Len(t, w.Bytes(), 18)
	assert.Equal(t, jpegHash, w.String())
}
...
func TestHashBlob(t *testing.T) {
	...
	hash := SumContent(data)
	assert.NotEmpty(t, hash)
	assert.Len(t, hash, 36)
	t.Logf("hash %s", hash)
	assert.Equal(t, jpegHash, hash)
}
